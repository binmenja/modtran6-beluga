function [] = modtran6_tape5_make_brb(path_modtran,nlyr,z,p,t,q,co2,o3,resolution,fwhm,cloud,v1,v2,angle,iLoc,emis,zt,ts)
    ...
    card1.tptemp = t(1);                    % boundary temperature, > 0 / <= 0
    end
    ...
    card2c.ird2 = 0;                     % 0-2
    card2c.hmodel = 'tape5_maker_brb.m';
    card2c.ree = ' ';
    card2c.nmolyc = 0;
    card2c.e_mass = 0;
    card2c.airmwt = 0;
